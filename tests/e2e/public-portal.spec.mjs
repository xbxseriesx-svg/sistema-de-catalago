...
test('portal público é independente e não carrega runtimes do editor', async ({ page }) => {
...
test('tipografia CSS permanece estável em larguras equivalentes a zoom do navegador', async ({ page }) => {
...
test('portal reflowa tablet e celular sem miniaturizar desktop', async ({ page }) => {
...
test('filtro de segmento e modal de produto permanecem funcionais', async ({ page }) => {

...
export function BuilderWorkspace() {
  ...
  const onDragStart = (event: DragStartEvent) => { const data = event.active.data.current; setActiveLabel(String(data?.label || data?.blockId || 'Bloco')) }

...
if (!bundle.includes(functionalPolishMarker)) execFileSync(process.execPath, ['scripts/patch-functional-polish-v90.mjs'], { stdio: 'inherit' });
bundle = await readFile(bundlePath, 'utf8');
...
console.log('Bundle validado com V81, performance V86 e correções funcionais V90.');

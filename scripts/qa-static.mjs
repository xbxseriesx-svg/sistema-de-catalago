...
assert.match(html, /responsive-v67\.js\?v=81/);
assert.match(html, /template-preview-v69\.css\?v=81/);
assert.match(html, /template-preview-v69\.js\?v=81/);
assert.match(html, /product-modal-v66\.js\?v=81/);
assert.match(html, /import-progress-v62\.js\?v=81/);
assert.match(html, /system-runtime-v80\.js\?v=81/);
...
assert.match(html, /marketing-canvas-hotfix\.js\?v=81/);
